...
//Changed the Sprites from aliens to pokemons for the enemis, and Spaceship to Ash (Pokemon Character) for the player//
...
var GameScreen = function GameScreen(text,text2,callback) {
  this.step = function(dt) {
    ...
    //Changed Colour of Text for Start and Game over Titles from White to Green//
